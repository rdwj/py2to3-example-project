...
class EmailAlert(object):
    ...
    def to_mime_message(self):
        ...
        body_str = safe_encode(self.body) if isinstance(self.body, str) else self.body
        msg = MIMEText(body_str, "plain", "utf-8")
        msg["Subject"] = safe_encode(self.subject) if isinstance(self.subject, str) else self.subject
...
class EmailSender(object):
    ...
    def send_daily_digest(self, list_name, report_content):
        ...
        body = safe_encode(report_content) if isinstance(report_content, str) else report_content
